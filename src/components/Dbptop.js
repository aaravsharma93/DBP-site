...
import { Container, Tabs, Tab, Card, Col, Row, Table, Button } from "react-bootstrap";
import "./Dbptop.css";
                ...
                >
                  ...
                  <Tab eventKey="Pool" title="Pool">
                    <>
                      <Row className="pool-upper">
                        ...
                        <Col lg={6}>
                          <div className="swap-ctn">
                            <Button variant="outlined" className="pool-btncrn">New Position</Button>
                          </div>
                  ...
                  <Tab eventKey="Explore" title="Explore">
                    ...
                    <h1 className="h1explore">Bond Explorer</h1>
                      ...
                      <Table className="Explore-tables">
                        <thead>
                          <tr>
                            <th>Bonds</th>
                            <th>APY</th>
